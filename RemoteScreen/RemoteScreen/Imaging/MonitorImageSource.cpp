#include "stdafx.h"
#include "MonitorImageSource.h"

#include <iostream>
#include "Win32Framework/Canvas.h"
#include "Win32Framework/DeviceContext.h"

HBITMAP MonitorImageSource::GetImage()
{
   return GetImage(GetSystemMetrics(SM_CXVIRTUALSCREEN), GetSystemMetrics(SM_CYVIRTUALSCREEN));
}
